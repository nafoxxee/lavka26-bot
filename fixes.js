// Основные исправления для рекламных объявлений

// 1. Исправить функцию отправки рекламного объявления в канал
...
// 2. Исправить обработчик подтверждения оплаты
...
// 3. Исправить обработчик скриншота оплаты
