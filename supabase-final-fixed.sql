-- Lavka26 Supabase Database Schema - Final Fixed Version
-- Правильный синтаксис для PostgreSQL и исправленный INSERT
...
-- 4. Вставка тестовых данных (исправлено - добавлен id)
INSERT INTO users (id, telegram_id, username, first_name, last_name) VALUES
    (12345, 12345, 'test_user', 'Test', 'User')
