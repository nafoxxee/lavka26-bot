-- Lavka26 Supabase Database Schema - Complete Version
-- Полная настройка базы данных с таблицами, индексами, RLS и тестовыми данными

-- 1. Удаление существующих таблиц (чистая установка)
DROP TABLE IF EXISTS CASCADE ad_views;
DROP TABLE IF EXISTS CASCADE messages;
DROP TABLE IF EXISTS CASCADE chats;
DROP TABLE IF EXISTS CASCADE favorites;
DROP TABLE IF EXISTS CASCADE ads;
...
-- 6. Функция для обновления времени
...
-- 7. Триггеры для обновления времени
